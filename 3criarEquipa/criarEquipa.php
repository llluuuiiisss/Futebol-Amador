...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="criarEquipa.css">
...
<div class="bodyContainer">
    <text class="title">Criar Equipa</text><img src="taca.png" class="tacaImg">
    <form action="action.php" method="post" id="myform" class="form">
        <br>
        <label>Nome: </label><input type="text" name="nome" placeholder="Introduza o nome...">
        <br>
        <input type="submit" form="myform" value="Validar" class="buttonValidate">
    </form>
