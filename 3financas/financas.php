...
<html lang="en">
    <head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="financas.css">
...
<div class="line"></div>
    ...
    <div class="bodyContainer">
        <text class="title">Finanças</text><br>
        <text class="textS">Saldo:</text><br><br>
        <form class="textS" action="action.php" method="post">
            Acrescentar Valor:<input type="number" name="value_to_add">
